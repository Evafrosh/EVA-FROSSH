...
def logo():
    ...
    os.system('echo -e "\n\n馃嚢.馃嚘.馃嚚.馃嚟.馃嚠\n\n-----------------------------------------------\n\n鉃� Codded By : EVA\n鉃� Facebook  : EVA FROSH\n鉃� Whatsapp   : +2349072939802\n鉃� Youtube   : No YouTube Channel Yet\n\n-----------------------------------------------" | lolcat')
...
def method_menu():
    ...
    print("\t    \033[1;34mClone Method Menu\033[0;91m")
...
def method_menu_select():
    ...
    if afza =="1":
        ...
        print("\t    \033[1;35mSelect valid option \033[0;91m")
...
def login():
    ...
    print("\x1b[1;94m[1] Token login")

    print("\x1b[1;94m[2] ID/Pass login")
...
def login_select():
    ...
    if afza =="1":
        ...
        print("\t    \033[1;32mFB Token Login\033[0;94m")
        ...
        try:
            ...
            print("\t\033[1;32mToken logged in as : "+nm+"\033[0;92m")
            ...
            print("\t    \033[1;31mToken not valid\033[0;92m")
...
def login_fb():
	...
	print("\t    \033[1;32mFB ID/PASS Login\033[0;92m")
	...
	if "loc" in q:
		...
		print("\t    \033[1;31mLogged in successfully\033[0;93m")
...
def b_menu():
    ...
    try:
        ...
        print("\t    \033[1;31m🙏Turn on mobile data OR wifi🙏 \033[0;97m")

        print("")

        time.sleep(1)

        raw_input("\x1b[1;93mPress enter to try again \033[0;91m")
    ...
    print("\x1b[1;91m[4] Find date of birth")

    print("\x1b[1;91m[5] Return method menu")

    print("\x1b[1;91m[6] Logout")
	...
	def main(arg):
		...
		try:
		    ...
		    if 'www.facebook.com' in d['error_msg']:
		        ...
		        print("\x1b[1;92m[EVAFROSH-CP] "+uid+" | "+pass1)
		    	...
		    	if "access_token" in d:
		            ...
		            print("\x1b[1;92m[EVA Hacked] \033[1;30m"+uid+" | "+pass1+"\x1b[1;0m")
		            ...
		            if 'www.facebook.com' in d['error_msg']:
		                ...
		                print("\x1b[1;93m[EVAFROSH-CP] "+uid+" | "+pass2)
		                ...
		                if 'access_token' in d:
		                    ...
		                    print("\x1b[1;92m[EVAFROSH-OK] \033[1;30m"+uid+" | "+pass2+"\x1b[1;0m")
		                    ...
		                    if 'www.facebook.com' in d['error_msg']:
		                        ...
		                        print("\x1b[1;93m[EVAFROSH-CP] "+uid+" | "+pass3)
		                        ...
		                        if 'access_token' in d:
		                            ...
		                            print(" \x1b[1;92m[EVAFROSH-OK] \033[1;30m"+uid+" | "+pass3+"\x1b[1;0m")
		                            ...
		                            if 'www.facebook.com' in d['error_msg']:
		                                ...
		                                if 'access_token' in d:
		                                    ...
		                                    print("\x1b[1;92m[EVAFROSH-OK] \033[1;30m"+uid+" | "+pass4+"\x1b[1;0m")
		                                    ...
		                                    if 'www.facebook.com' in d['error_msg']:
		                                        ...
		                                        print("\x1b[1;93m[EVAFROSH-CP] "+uid+" | "+pass5)
		                                        ...
		                                        if 'access_token' in d:
		                                            ...
		                                            print("\x1b[1;92m[EVAFROSH-OK] \033[1;30m"+uid+" | "+pass5+"\x1b[1;0m")
		                                            ...
		                                            if 'www.facebook.com' in d['error_msg']:
		                                                ...
		                                                print("\x1b[1;93m[EVAFROSH-CP] "+uid+" | "+pass6)
		                                                ...
		                                                if 'access_token' in d:
		                                                    ...
		                                                    print("\x1b[1;92m[EVAFROSH-OK] \033[1;30m"+uid+" | "+pass6+"\x1b[1;0m")
		                                                    ...
		                                                    if 'www.facebook.com' in d['error_msg']:
		                                                        ...
		                                                        print("\x1b[1;93m[EVAFROSH-CP] "+uid+" | "+pass7)
		                                                        ...
		                                                        if 'access_token' in d:
		                                                            ...
		                                                            print("\x1b[1;92m[EVAFROSH-OK] \033[1;30m"+uid+" | "+pass7+"\x1b[1;0m")
...
def extract_dob():
    ...
    print("\x1b[1;92m[1] Grab from friendlist")

    print("\x1b[1;92m[2] Grab from followers")

    print("\x1b[1;92m[3] Grab single id")
...
def l_menu():
    ...
    print("\x1b[1;91m[3] Return method menu")
